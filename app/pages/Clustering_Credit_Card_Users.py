...
@st.cache
def predict(balance, balance_frequency, purchases, one_off_purchases, installment_purchases, cash_advance, purchases_frequency, one_off_purchases_frequency, installment_purchases_frequency, cash_advance_frequency, cash_advance_trx, purchases_trx, credit_limit, minimum_payments, full_payment, tenure):
  return model.predict(pd.DataFrame([[balance, balance_frequency/100, purchases, one_off_purchases, installment_purchases, cash_advance, purchases_frequency/100, one_off_purchases_frequency/100, installment_purchases_frequency/100, cash_advance_frequency/100, cash_advance_trx, purchases_trx, credit_limit, minimum_payments, full_payment/100, tenure]]))
...
if st.button('Predict'):
  prediction = predict(balance, balance_frequency, purchases, one_off_purchases, installment_purchases, cash_advance, purchases_frequency, one_off_purchases_frequency, installment_purchases_frequency, cash_advance_frequency, cash_advance_trx, purchases_trx, credit_limit, minimum_payments, full_payment, tenure)
